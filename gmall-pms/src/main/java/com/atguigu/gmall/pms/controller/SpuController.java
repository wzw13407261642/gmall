...
public class SpuController {
    ...
    //category/0?t=1595321280930&pageNum=1&pageSize=10&key=



    @GetMapping("category/{categoryId}")
    public ResponseVo<PageResultVo> getSpuPageList(@PathVariable("categoryId") Long categoryId,
                                                   PageParamVo pageParamVo) {
        PageResultVo pageResultVo = spuService.getSpuPageList(categoryId, pageParamVo);
